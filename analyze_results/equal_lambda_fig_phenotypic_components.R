...
### *specifically for the equal-lambda simulations*
### from the shorter batch (200 sims only) over time.
### This recreates Supporting Info Figures S20-21.
...
# Load in data (NOTE: this is the equal-lambda data output)
z.com = read.csv('run_sims/out/equal_lambda/sim_results_m1_phenotypic_components.csv')
...
# Plot of component means over time (Fig. S20)
z.bar %>% 
...
ggsave('analyze_results/figs_out/figS20_pheno_comp_mean.pdf',
       width = 8, height = 3)


# Plot of component variances over time (Fig. S21)
z.var %>% 
...
ggsave('analyze_results/figs_out/figS21_pheno_comp_vars.pdf',
       width = 8, height = 3)
