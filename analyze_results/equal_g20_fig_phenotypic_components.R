...
### This script is for the figures with initial cohort variance equal
### (Figs. S25 and S26)
...
# Load in data
z.com = read.csv('run_sims/out/sim_results_m1_phtype_equalg20.csv')
...
# Component means over time (Fig. S25)
z.bar %>% 
...
ggsave('analyze_results/figs_out/figS25_pheno_comp_mean.pdf',
       width = 8, height = 3)


# Component variances (Fig. S26)
z.var %>% 
...
ggsave('analyze_results/figs_out/figS26_pheno_comp_vars.pdf',
       width = 8, height = 3)
